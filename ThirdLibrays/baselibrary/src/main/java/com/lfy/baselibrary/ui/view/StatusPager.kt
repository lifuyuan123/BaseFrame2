package com.lfy.baselibrary.ui.view
...
class StatusPager private constructor(private val mBuilder: Builder) :
    ...
    class Builder(var mTarget: View) {
        ...
        var mLoadingId =R.layout.state_loading
        var mEmptyId = R.layout.state_empty
        var mErrorId = R.layout.state_error
         ...
         * 加载页布局资源id
         */
        fun loadingViewLayout(@LayoutRes layoutRes: Int=R.layout.state_loading): Builder {
         ...
         * 空页面布局资源id
         */
        fun emptyViewLayout(@LayoutRes layoutRes: Int= R.layout.state_empty): Builder {
            mEmptyId = layoutRes
            return this
        }
         ...
         * 错误页面布局资源id
         */
        fun errorViewLayout(@LayoutRes layoutRes: Int=R.layout.state_error): Builder {
            mErrorId = layoutRes
            return this
        }
