...
import com.lfy.baselibrary.utils.print.CharacterHandler.Companion.xmlFormat
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    override fun printJsonResponse(
        ...
        bodyString = if (RequestInterceptor.isJson(contentType)) jsonFormat(
            bodyString!!
        ) else if (RequestInterceptor.isXml(contentType)) xmlFormat(bodyString) else bodyString
