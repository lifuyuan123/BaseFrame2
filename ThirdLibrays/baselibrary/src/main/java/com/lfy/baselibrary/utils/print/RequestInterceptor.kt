...
import com.lfy.baselibrary.utils.print.CharacterHandler.Companion.jsonFormat
import com.lfy.baselibrary.utils.print.ZipHelper.Companion.decompressForGzip
import com.lfy.baselibrary.utils.print.ZipHelper.Companion.decompressToStringForZlib
...
class RequestInterceptor(
    ...
    val handlerListenerImpl: HttpHandlerListener
) : Interceptor {
    private var mPrinter = DefaultFormatPrinter()
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val originalResponse: Response = try {
            ...
            responseErrorListener.handleResponseError(e)
//            Log.e("Http Error: ", e.toString())
        ...
        return handlerListenerImpl.onHttpResultResponse(bodyString, chain, originalResponse)
    }
    ...
    companion object {
        ...
        fun isParseable(mediaType: MediaType?): Boolean {
            return if (mediaType?.type == null) false else isText(mediaType) || isPlain(
                mediaType
            )
